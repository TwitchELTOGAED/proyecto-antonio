...
export default function LoginPage() {
  return (
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      {/* 1. IMAGEN DE FONDO (Con superposición oscura para que resalte el rojo) */}
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-black/70"></div> {/* Capa oscura extra */}
      </div>

      {/* 2. TARJETA ROJA (El diseño del PDF) */}
